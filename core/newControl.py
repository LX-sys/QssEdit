...
class NewControl(QWidget):
    ...
    def get_default_icon(self,name) -> QIcon:
        icon = QIcon()
        if "QPushButton" == name:
            icon.addFile(os.path.join(icon_Path,"button.png"), QtCore.QSize(16, 16), QIcon.Normal, QIcon.Off)
        elif "QLineEdit" == name:
            icon.addFile(os.path.join(icon_Path,"lineEdit.png"), QtCore.QSize(16, 16), QIcon.Normal, QIcon.Off)
        elif "QToolButton" == name:
            icon.addFile(os.path.join(icon_Path, "toolbutton.png"), QtCore.QSize(16, 16), QIcon.Normal, QIcon.Off)
        elif "QRadioButton" == name:
            icon.addFile(os.path.join(icon_Path, "radioButton.png"), QtCore.QSize(16, 16), QIcon.Normal, QIcon.Off)
        elif "QCheckBox" == name:
            icon.addFile(os.path.join(icon_Path, "checkBox.png"), QtCore.QSize(16, 16), QIcon.Normal, QIcon.Off)
        elif "QCommandLinkButton" == name:
            icon.addFile(os.path.join(icon_Path, "commandLinkButton.png"), QtCore.QSize(16, 16), QIcon.Normal, QIcon.Off)
        elif "QDialogButtonBox" == name:
            pass
        elif "QTextEdit" == name:
            icon.addFile(os.path.join(icon_Path, "textEdit.png"), QtCore.QSize(16, 16), QIcon.Normal,QIcon.Off)
        elif "QComboBox" == name:
            icon.addFile(os.path.join(icon_Path, "comboBox.png"), QtCore.QSize(16, 16), QIcon.Normal, QIcon.Off)
        else:
            icon = None

...
class ColorLib:
    ...
    # 添加颜色
    @staticmethod
    def addColor(key:str,value:str):
        if value[0] == "#":
            ColorLib.cnames[key] = value
        else:
            raise ValueError("158")
...
def colorToRGB(color:str) -> tuple:
    ...
    if "#" == color[0]:  # 类型 #xxxxxx
        ...
        color_lib = ColorLib.cnames
        if color_lib.get(color):
            color = color_lib.get(color)
        else:
            raise KeyError("202")
    # 去除#
    color = color[1:]
...
# print(colorToRGB("rgb(241, 255, 254)"))
# print(colorToRGB("c"))
# ColorLib.addColor("cc","000000")
# 颜色取反
def coloReverse(color):
